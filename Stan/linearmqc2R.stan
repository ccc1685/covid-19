...
functions { // time transition functions for beta and sigmac
        ...
        transformed data {
            ...
            int x_i[0];
            // real q = 0.;
            int n_difeq = 7;     // number of differential equations for yhat
        }
        ...
        transformed parameters{
          ...
          {
             real theta[9] = {f1, f2, sigmar, sigmad, sigmau, q, mbase, mlocation,sigmar1};
            ...
            //print(u_init)
             ...
             for (i in 2:n_obs){
                ...
                lambda[i,2] = (u[i,7]-u[i-1,7])*n_scale; //R: recovered rate per day
                lambda[i,3] = (u[i,5]-u[i-1,5])*n_scale; //D: dead rate per day
                }
            }
        }
