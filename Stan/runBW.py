...
stanrunmodel = pystan.StanModel(file=stan_raw)
# load_or_compile_stan_model(model_name, force_recompile=False)
...
init_fixed =  [{'theta':[2.5,0.05,0.05,0.05,0.05,.05,0.1,10.0]}]
# ## Fit Stan
...
save_path = "/data/carsonc/covid-19/fits/" +  model_name + "_" + roi + ".pkl"
